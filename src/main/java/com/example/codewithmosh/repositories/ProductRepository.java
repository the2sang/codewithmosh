...
import com.example.codewithmosh.dtos.ProductSummaryDTO;
import com.example.codewithmosh.entities.Category;
...
public interface ProductRepository
    ...
    @Query("select new com.example.codewithmosh.dtos.ProductSummaryDTO(p.id, p.name) from Product p where p.category = :category")
